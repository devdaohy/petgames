function labnolThumb(e) {
  return (
    '<img src="https://i.ytimg.com/vi/ID/hqdefault.jpg">'.replace("ID", e) +
    '<div class="play"></div>'
  );
}
function labnolIframe() {
  ...
  e.setAttribute(
    "src",
    "https://www.youtube.com/embed/ID?autoplay=1".replace("ID", this.dataset.id)
  ),
...
$(document).ready(function () {
  ...
  e.swiperight(function () {
    ...
    $('a[href^="#"]').on("click", function (e) {
      ...
      $("html, body")
        .stop()
        .animate({ scrollTop: s.offset().top }, 900, "swing");
    }),
    $(".gallery-item").on("click", function () {
      var e = $("#myModalLabel"),
        t = $("#showcase-img"),
        s = $("#modal-price-tag"),
        l = ($("#modalBody"), $(this).find("img"));
      $("#model-feats").find("li");
      e.text("Sweet World: " + $(this).find("#item-name-caption").text()),
        s.text($(this).find("#item-price-caption").text()),
        t.attr("src", l.attr("src"));
    }),
    $("div#item-1, div#item-2, div#item-3, div#item-4").on(
      "click",
      function () {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    var e,
      t,
      s = document.getElementsByClassName("youtube-player");
    for (t = 0; t < s.length; t++)
      (e = document.createElement("div")).setAttribute(
        "data-id",
        s[t].dataset.id
      ),
        (e.innerHTML = labnolThumb(s[t].dataset.id)),
        (e.onclick = labnolIframe),
        s[t].appendChild(e);
  }),
  $(window)
    .resize(function () {
